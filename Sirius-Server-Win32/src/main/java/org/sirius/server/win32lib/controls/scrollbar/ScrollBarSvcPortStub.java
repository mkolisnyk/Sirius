...
public class ScrollBarSvcPortStub extends org.apache.axis.client.Stub implements
    ...
    public ScrollBarSvcPortStub(final java.net.URL endpointURL,
    ...
    public ScrollBarSvcPortStub(final javax.xml.rpc.Service service)
            throws org.apache.axis.AxisFault {
        if (service == null) {
