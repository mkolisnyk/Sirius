...
public class ButtonSvcPortStub extends org.apache.axis.client.Stub implements
    ...
    private static void _initOperationDesc1() {
        ...
        param = new org.apache.axis.description.ParameterDesc(
                new javax.xml.namespace.QName(
                        "http://button.controls.win32lib.server.sirius.org/",
                        "check"), org.apache.axis.description.ParameterDesc.IN,
                new javax.xml.namespace.QName(
                        "http://www.w3.org/2001/XMLSchema", "boolean"),
    ...
    public ButtonSvcPortStub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public ButtonSvcPortStub(final java.net.URL endpointURL,
    ...
    public ButtonSvcPortStub(final javax.xml.rpc.Service service)
            throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public void click(final java.lang.Integer hwnd)
        ...
        _call.setSOAPActionURI("http://button.controls.win32lib.server.sirius.org/IButtonContract/Click");
        ...
        _call.setOperationName(new javax.xml.namespace.QName(
                "http://button.controls.win32lib.server.sirius.org/", "Click"));
    ...
    public java.lang.Boolean isChecked(final java.lang.Integer hwnd)
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://button.controls.win32lib.server.sirius.org/IButtonContract/IsChecked");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR,
                Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS,
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                try {
                    ...
                    return (java.lang.Boolean) org.apache.axis.utils.JavaUtils
                            .convert(_resp, java.lang.Boolean.class);
                }
            }
        } catch (org.apache.axis.AxisFault axisFaultException) {
            throw axisFaultException;
    ...
    public java.lang.Boolean isIntermediate(final java.lang.Integer hwnd)
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://button.controls.win32lib.server.sirius.org/IButtonContract/IsIntermediate");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR,
                Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS,
    ...
    public java.lang.Boolean isPressed(final java.lang.Integer hwnd)
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://button.controls.win32lib.server.sirius.org/IButtonContract/IsPressed");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR,
                Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS,
    ...
    public void setCheck(final java.lang.Integer hwnd,
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://button.controls.win32lib.server.sirius.org/IButtonContract/SetCheck");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR,
                Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS,
