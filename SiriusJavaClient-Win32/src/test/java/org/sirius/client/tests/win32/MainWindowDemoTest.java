...
public class MainWindowDemoTest {
	...
	public void menuOperations() throws Exception {
		...
		Assert.assertTrue(notepad.openDialog.exists(IWin32Options.DEFAULT_TIMEOUT));
		Assert.assertTrue(notepad.openDialog.isVisible(IWin32Options.DEFAULT_TIMEOUT));
		...
		Assert.assertTrue(notepad.openDialog.disappears(IWin32Options.DEFAULT_TIMEOUT));
		
		notepad.edtText.typeKeys("Hello World!!!");
		
		notepad.close();
		Assert.assertTrue(notepad.dSave.exists(IWin32Options.DEFAULT_TIMEOUT));
		Assert.assertTrue(notepad.dSave.btnNO.exists(IWin32Options.DEFAULT_TIMEOUT));
