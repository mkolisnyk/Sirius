...
public class TabControlDemoTest {
	...
	public class ControlsExamplesDialog extends DialogBox {
		...
		public PageList plstTabs = new PageList(this,new Win32Locator("SysTabControl32",0));
		public Button btnClose = new Button(this,new Win32Locator("Button","Close",0));
		...
		public ControlsExamplesDialog(Win32Client client) {
			super(client, new Win32Locator("(.*)","Common Controls Examples",0));
		}
		
		public void start() throws Exception {
			try {
				this.client.core().window().start(getHwnd(), "D:/Work/SiriusDev/Sirius/TestApps/win32/Controls.exe", "", "");
			}
			catch(Exception e){
				e.printStackTrace();
				throw e;
