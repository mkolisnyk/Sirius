...
public class TcHITTESTINFO extends org.sirius.client.win32.core.types.Structure
    ...
    public TcHITTESTINFO(boolean autoRead, boolean autoWrite,
            org.sirius.client.win32.core.types.Point pt, int flags) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TcHITTESTINFO))
            return false;
