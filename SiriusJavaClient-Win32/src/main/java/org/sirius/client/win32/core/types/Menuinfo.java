...
public class Menuinfo  extends org.sirius.client.win32.core.types.Structure  implements java.io.Serializable {
    private int cbSize;
     ...
     */
    public void setDwContextHelpID(org.sirius.client.win32.core.types.Dword dwContextHelpID) {
        this.dwContextHelpID = dwContextHelpID;
    }
     ...
     * @param dwMenuData
     */
    public void setDwMenuData(org.sirius.client.win32.core.types.UlongPTR dwMenuData) {
        this.dwMenuData = dwMenuData;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.dwStyle==null && other.getDwStyle()==null) || 
             (this.dwStyle!=null &&
              this.dwStyle.equals(other.getDwStyle()))) &&
            ((this.cyMax==null && other.getCyMax()==null) || 
             (this.cyMax!=null &&
              this.cyMax.equals(other.getCyMax()))) &&
            ((this.hbrBack==null && other.getHbrBack()==null) || 
             (this.hbrBack!=null &&
              this.hbrBack.equals(other.getHbrBack()))) &&
            ((this.dwContextHelpID==null && other.getDwContextHelpID()==null) || 
             (this.dwContextHelpID!=null &&
              this.dwContextHelpID.equals(other.getDwContextHelpID()))) &&
            ((this.dwMenuData==null && other.getDwMenuData()==null) || 
             (this.dwMenuData!=null &&
              this.dwMenuData.equals(other.getDwMenuData())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://core.win32.server.sirius.org/", "menuinfo"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://core.win32.server.sirius.org/", "uint"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://core.win32.server.sirius.org/", "hbrush"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dwContextHelpID");
        elemField.setXmlName(new javax.xml.namespace.QName("", "dwContextHelpID"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://core.win32.server.sirius.org/", "dword"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
