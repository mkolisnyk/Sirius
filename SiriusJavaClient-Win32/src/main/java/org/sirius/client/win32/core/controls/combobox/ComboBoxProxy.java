...
public class ComboBoxProxy implements org.sirius.client.win32.core.controls.combobox.ComboBox {
  ...
  private void _initComboBoxProxy() {
    try {
      comboBox = (new org.sirius.client.win32.core.controls.combobox.ComboBoxServiceLocator()).getComboBoxPort();
      if (comboBox != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)comboBox)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)comboBox)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
