...
public class TabControlProxy implements
        org.sirius.client.win32.core.controls.tabcontrol.TabControl {
    ...
    private void _initTabControlProxy() {
        try {
            tabControl = (new org.sirius.client.win32.core.controls.tabcontrol.TabControlServiceLocator())
                    .getTabControlPort();
            if (tabControl != null) {
                if (_endpoint != null)
                    ((javax.xml.rpc.Stub) tabControl)
                            ._setProperty(
                                    "javax.xml.rpc.service.endpoint.address",
                                    _endpoint);
                else
                    _endpoint = (String) ((javax.xml.rpc.Stub) tabControl)
    ...
    public void setEndpoint(String endpoint) {
        _endpoint = endpoint;
        if (tabControl != null)
            ((javax.xml.rpc.Stub) tabControl)._setProperty(
