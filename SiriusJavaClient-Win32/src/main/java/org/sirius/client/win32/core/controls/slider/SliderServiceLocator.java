...
public class SliderServiceLocator extends org.apache.axis.client.Service implements org.sirius.client.win32.core.controls.slider.SliderService {
    ...
    public org.sirius.client.win32.core.controls.slider.Slider getSliderPort() throws javax.xml.rpc.ServiceException {
    ...
    public org.sirius.client.win32.core.controls.slider.Slider getSliderPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.sirius.client.win32.core.controls.slider.SliderPortBindingStub _stub = new org.sirius.client.win32.core.controls.slider.SliderPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.sirius.client.win32.core.controls.slider.Slider.class.isAssignableFrom(serviceEndpointInterface)) {
                org.sirius.client.win32.core.controls.slider.SliderPortBindingStub _stub = new org.sirius.client.win32.core.controls.slider.SliderPortBindingStub(new java.net.URL(SliderPort_address), this);
                _stub.setPortName(getSliderPortWSDDServiceName());
                return _stub;
            }
        }
