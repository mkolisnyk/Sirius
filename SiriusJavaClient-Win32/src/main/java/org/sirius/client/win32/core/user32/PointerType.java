...
public abstract class PointerType implements java.io.Serializable {
	private org.sirius.client.win32.core.user32.Pointer pointer;

	public PointerType() {
	}

	public PointerType(org.sirius.client.win32.core.user32.Pointer pointer) {
	 ...
	 * @return pointer
	 */
	public org.sirius.client.win32.core.user32.Pointer getPointer() {
		return pointer;
	}
	 ...
	 * @param pointer
	 */
	public void setPointer(org.sirius.client.win32.core.user32.Pointer pointer) {
		this.pointer = pointer;
	}
