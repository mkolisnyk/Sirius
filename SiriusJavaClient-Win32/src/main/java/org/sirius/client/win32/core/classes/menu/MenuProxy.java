...
public class MenuProxy implements org.sirius.client.win32.core.classes.menu.Menu {
  ...
  private void _initMenuProxy() {
    try {
      menu = (new org.sirius.client.win32.core.classes.menu.MenuServiceLocator()).getMenuPort();
      if (menu != null) {
        if (_endpoint != null)
