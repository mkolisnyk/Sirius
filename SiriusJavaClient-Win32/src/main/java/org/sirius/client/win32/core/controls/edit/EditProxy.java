...
public class EditProxy implements
    ...
    private void _initEditProxy() {
        try {
            edit = (new org.sirius.client.win32.core.controls.edit.EditServiceLocator())
                    .getEditPort();
            if (edit != null) {
                if (_endpoint != null)
                    ((javax.xml.rpc.Stub) edit)
                            ._setProperty(
                                    "javax.xml.rpc.service.endpoint.address",
                                    _endpoint);
                else
                    _endpoint = (String) ((javax.xml.rpc.Stub) edit)
    ...
    public void setEndpoint(String endpoint) {
        _endpoint = endpoint;
        if (edit != null)
            ((javax.xml.rpc.Stub) edit)._setProperty(
