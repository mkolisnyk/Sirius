...
public class Keybdinput  extends org.sirius.client.win32.core.types.Structure  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Keybdinput)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.wVk==null && other.getWVk()==null) || 
             (this.wVk!=null &&
              this.wVk.equals(other.getWVk()))) &&
            ((this.wScan==null && other.getWScan()==null) || 
             (this.wScan!=null &&
              this.wScan.equals(other.getWScan()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Keybdinput.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://core.win32.server.sirius.org/", "keybdinput"));
