...
public class Menuiteminfo extends org.sirius.client.win32.core.types.Structure
	...
	public Menuiteminfo(boolean autoRead, boolean autoWrite, int cbSize,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.fType == null && other.getFType() == null) || (this.fType != null && this.fType
						.equals(other.getFType())))
				&& ((this.fState == null && other.getFState() == null) || (this.fState != null && this.fState
						.equals(other.getFState())))
				&& ((this.wID == null && other.getWID() == null) || (this.wID != null && this.wID
						.equals(other.getWID())))
				&& ((this.hSubMenu == null && other.getHSubMenu() == null) || (this.hSubMenu != null && this.hSubMenu
						.equals(other.getHSubMenu())))
				&& ((this.hbmpChecked == null && other.getHbmpChecked() == null) || (this.hbmpChecked != null && this.hbmpChecked
						.equals(other.getHbmpChecked())))
				&& ((this.hbmpUnchecked == null && other.getHbmpUnchecked() == null) || (this.hbmpUnchecked != null && this.hbmpUnchecked
						.equals(other.getHbmpUnchecked())))
				&& ((this.dwItemData == null && other.getDwItemData() == null) || (this.dwItemData != null && this.dwItemData
						.equals(other.getDwItemData())))
				&& ((this.dwTypeData == null && other.getDwTypeData() == null) || (this.dwTypeData != null && this.dwTypeData
						.equals(other.getDwTypeData())))
				&& ((this.cch == null && other.getCch() == null) || (this.cch != null && this.cch
						.equals(other.getCch())))
				&& ((this.hbmpItem == null && other.getHbmpItem() == null) || (this.hbmpItem != null && this.hbmpItem
						.equals(other.getHbmpItem())));
		__equalsCalc = null;
		return _equals;
	}
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("", "hbmpUnchecked"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://classes.win32.server.sirius.org/", "hbitmap"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
