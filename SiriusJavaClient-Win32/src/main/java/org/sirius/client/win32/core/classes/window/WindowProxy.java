...
public class WindowProxy implements
		org.sirius.client.win32.core.classes.window.Window {
	...
	private void _initWindowProxy() {
		try {
			window = (new org.sirius.client.win32.core.classes.window.WindowServiceLocator())
					.getWindowPort();
			if (window != null) {
				if (_endpoint != null)
					((javax.xml.rpc.Stub) window)
							._setProperty(
									"javax.xml.rpc.service.endpoint.address",
									_endpoint);
				else
					_endpoint = (String) ((javax.xml.rpc.Stub) window)
	...
	public void setEndpoint(String endpoint) {
		_endpoint = endpoint;
		if (window != null)
			((javax.xml.rpc.Stub) window)._setProperty(
