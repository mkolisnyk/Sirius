...
public class Msg extends org.sirius.client.win32.core.user32.Structure
		implements java.io.Serializable {
	private org.sirius.client.win32.core.user32.Hwnd hWnd;

	private int message;

	private org.sirius.client.win32.core.user32.Wparam wParam;

	private org.sirius.client.win32.core.user32.Lparam lParam;

	private int time;

	private org.sirius.client.win32.core.user32.Point pt;

	public Msg() {
	}

	public Msg(boolean autoRead, boolean autoWrite,
			org.sirius.client.win32.core.user32.Hwnd hWnd, int message,
			org.sirius.client.win32.core.user32.Wparam wParam,
			org.sirius.client.win32.core.user32.Lparam lParam, int time,
			org.sirius.client.win32.core.user32.Point pt) {
	 ...
	 * @return hWnd
	 */
	public org.sirius.client.win32.core.user32.Hwnd getHWnd() {
		return hWnd;
	}
	 ...
	 * @param hWnd
	 */
	public void setHWnd(org.sirius.client.win32.core.user32.Hwnd hWnd) {
		this.hWnd = hWnd;
	}
	 ...
	 * @return wParam
	 */
	public org.sirius.client.win32.core.user32.Wparam getWParam() {
		return wParam;
	}
	 ...
	 * @param wParam
	 */
	public void setWParam(org.sirius.client.win32.core.user32.Wparam wParam) {
		this.wParam = wParam;
	}
	 ...
	 * @return lParam
	 */
	public org.sirius.client.win32.core.user32.Lparam getLParam() {
		return lParam;
	}
	 ...
	 * @param lParam
	 */
	public void setLParam(org.sirius.client.win32.core.user32.Lparam lParam) {
		this.lParam = lParam;
	}
	 ...
	 * @return pt
	 */
	public org.sirius.client.win32.core.user32.Point getPt() {
		return pt;
	}
	 ...
	 * @param pt
	 */
	public void setPt(org.sirius.client.win32.core.user32.Point pt) {
		this.pt = pt;
	}
