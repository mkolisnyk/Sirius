...
public class Keybdinput extends org.sirius.client.win32.core.user32.Structure
		implements java.io.Serializable {
	private org.sirius.client.win32.core.user32.Word wVk;

	private org.sirius.client.win32.core.user32.Word wScan;
	...
	public Keybdinput(boolean autoRead, boolean autoWrite,
			org.sirius.client.win32.core.user32.Word wVk,
			org.sirius.client.win32.core.user32.Word wScan,
	 ...
	 * @return wVk
	 */
	public org.sirius.client.win32.core.user32.Word getWVk() {
		return wVk;
	}
	 ...
	 * @param wVk
	 */
	public void setWVk(org.sirius.client.win32.core.user32.Word wVk) {
		this.wVk = wVk;
	}
	 ...
	 * @return wScan
	 */
	public org.sirius.client.win32.core.user32.Word getWScan() {
		return wScan;
	}
	 ...
	 * @param wScan
	 */
	public void setWScan(org.sirius.client.win32.core.user32.Word wScan) {
		this.wScan = wScan;
	}
