...
public class Win32UtilsServiceLocator extends org.apache.axis.client.Service
		implements org.sirius.client.win32.utils.Win32UtilsService {
	...
	public Win32UtilsServiceLocator(java.lang.String wsdlLoc,
	...
	public org.sirius.client.win32.utils.Win32Utils getWin32UtilsPort(
		...
		try {
			org.sirius.client.win32.utils.Win32UtilsPortBindingStub _stub = new org.sirius.client.win32.utils.Win32UtilsPortBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (org.sirius.client.win32.utils.Win32Utils.class
					.isAssignableFrom(serviceEndpointInterface)) {
				org.sirius.client.win32.utils.Win32UtilsPortBindingStub _stub = new org.sirius.client.win32.utils.Win32UtilsPortBindingStub(
						new java.net.URL(Win32UtilsPort_address), this);
				_stub.setPortName(getWin32UtilsPortWSDDServiceName());
				return _stub;
			}
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName("http://win32.server.sirius.org/",
				"Win32UtilsService");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName(
					"http://win32.server.sirius.org/", "Win32UtilsPort"));
		}
