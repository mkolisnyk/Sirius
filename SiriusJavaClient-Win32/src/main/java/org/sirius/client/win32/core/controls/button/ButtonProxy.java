...
public class ButtonProxy implements org.sirius.client.win32.core.controls.button.Button {
  ...
  private void _initButtonProxy() {
    try {
      button = (new org.sirius.client.win32.core.controls.button.ButtonServiceLocator()).getButtonPort();
      if (button != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)button)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)button)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
