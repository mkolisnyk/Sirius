...
public class Mouseinput  extends org.sirius.client.win32.core.types.Structure  implements java.io.Serializable {
    private org.sirius.client.win32.core.types._long dx;

    private org.sirius.client.win32.core.types._long dy;

    private org.sirius.client.win32.core.types.Dword mouseData;
    ...
    public Mouseinput(
           boolean autoRead,
           boolean autoWrite,
           org.sirius.client.win32.core.types._long dx,
           org.sirius.client.win32.core.types._long dy,
           org.sirius.client.win32.core.types.Dword mouseData,
     ...
     * @return dx
     */
    public org.sirius.client.win32.core.types._long getDx() {
        return dx;
    }
     ...
     * @param dx
     */
    public void setDx(org.sirius.client.win32.core.types._long dx) {
        this.dx = dx;
    }
     ...
     * @return dy
     */
    public org.sirius.client.win32.core.types._long getDy() {
        return dy;
    }
     ...
     * @param dy
     */
    public void setDy(org.sirius.client.win32.core.types._long dy) {
        this.dy = dy;
    }
     ...
     * @return mouseData
     */
    public org.sirius.client.win32.core.types.Dword getMouseData() {
        return mouseData;
    }
     ...
     * @param mouseData
     */
    public void setMouseData(org.sirius.client.win32.core.types.Dword mouseData) {
        this.mouseData = mouseData;
    }
     ...
     * @param dwExtraInfo
     */
    public void setDwExtraInfo(org.sirius.client.win32.core.types.UlongPTR dwExtraInfo) {
        this.dwExtraInfo = dwExtraInfo;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof Mouseinput)) return false;
        ...
        _equals = super.equals(obj) && 
            ((this.dx==null && other.getDx()==null) || 
             (this.dx!=null &&
              this.dx.equals(other.getDx()))) &&
            ((this.dy==null && other.getDy()==null) || 
             (this.dy!=null &&
              this.dy.equals(other.getDy()))) &&
            ((this.mouseData==null && other.getMouseData()==null) || 
             (this.mouseData!=null &&
              this.mouseData.equals(other.getMouseData()))) &&
            ((this.dwFlags==null && other.getDwFlags()==null) || 
             (this.dwFlags!=null &&
              this.dwFlags.equals(other.getDwFlags()))) &&
            ((this.time==null && other.getTime()==null) || 
             (this.time!=null &&
              this.time.equals(other.getTime()))) &&
            ((this.dwExtraInfo==null && other.getDwExtraInfo()==null) || 
             (this.dwExtraInfo!=null &&
              this.dwExtraInfo.equals(other.getDwExtraInfo())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Mouseinput.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://core.win32.server.sirius.org/", "mouseinput"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("dx");
        elemField.setXmlName(new javax.xml.namespace.QName("", "dx"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://core.win32.server.sirius.org/", "long"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://core.win32.server.sirius.org/", "ulongPTR"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
