...
require 'SliderServiceMappingRegistry.rb'
require 'soap/rpc/driver'

module Sirius::Client::Win32::Core::Slider


class Slider < ::SOAP::RPC::Driver  DefaultEndpointUrl = "http:localhost:21212/win32/slider"
  Methods = [
    [ "",
      "getLowerBound",
    ...
    self.mapping_registry = SliderServiceMappingRegistry::EncodedRegistry
    self.literal_mapping_registry = SliderServiceMappingRegistry::LiteralRegistry
    init_methods
  end
private
