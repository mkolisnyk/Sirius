...
class Window < ::SOAP::RPC::Driver  DefaultEndpointUrl = "http:localhost:21212/win32/window"
  Methods = [
    ...
    [ "",
      "getDesktopWindow",
      [ [:in, "parameters", ["::SOAP::SOAPElement", "http:classes.win32.server.sirius.org/", "getDesktopWindow"]],
        [:out, "parameters", ["::SOAP::SOAPElement", "http:classes.win32.server.sirius.org/", "getDesktopWindowResponse"]] ],
      { :request_style =>  :document, :request_use =>  :literal,
        :response_style => :document, :response_use => :literal,
        :faults => {} }
    ],
