...
module WindowServiceMappingRegistry  EncodedRegistry = ::SOAP::Mapping::EncodedRegistry.new
  ...
  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Window::GetDesktopWindow,
    :schema_type => XSD::QName.new(NsClassesWin32ServerSiriusOrg, "getDesktopWindow"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Window::GetDesktopWindowResponse,
    :schema_type => XSD::QName.new(NsClassesWin32ServerSiriusOrg, "getDesktopWindowResponse"),
    :schema_element => [
      ["v_return", ["SOAP::SOAPLong", XSD::QName.new(nil, "return")]]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => Sirius::Client::Win32::Core::Window::GetDesktopWindow,
    :schema_name => XSD::QName.new(NsClassesWin32ServerSiriusOrg, "getDesktopWindow"),
    :schema_element => []
  )

  LiteralRegistry.register(
    :class => Sirius::Client::Win32::Core::Window::GetDesktopWindowResponse,
    :schema_name => XSD::QName.new(NsClassesWin32ServerSiriusOrg, "getDesktopWindowResponse"),
    :schema_element => [
      ["v_return", ["SOAP::SOAPLong", XSD::QName.new(nil, "return")]]
    ]
  )
