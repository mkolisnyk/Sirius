...
module Sirius  module Win32    module Core      module Utils
        module Win32UtilsServiceMappingRegistry  EncodedRegistry = ::SOAP::Mapping::EncodedRegistry.new
          ...
          :class => Sirius::Win32::Core::Utils::SearchSameThreadWindow,
          :schema_type => XSD::QName.new(NsWin32ServerSiriusOrg, "searchSameThreadWindow"),
          :schema_element => [
            ["arg0", ["SOAP::SOAPLong", XSD::QName.new(nil, "arg0")]],
            ["arg1", ["Sirius::Win32::Core::Utils::Win32Locator", XSD::QName.new(nil, "arg1")], [0, 1]]
          ]
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Utils::Win32Locator,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Utils::SearchSameThreadWindowResponse,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Utils::SearchWindow,
          :schema_type => XSD::QName.new(NsWin32ServerSiriusOrg, "searchWindow"),
          :schema_element => [
            ["arg0", ["Sirius::Win32::Core::Utils::Win32Locator", XSD::QName.new(nil, "arg0")], [0, 1]]
          ]
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Utils::SearchWindowResponse,
