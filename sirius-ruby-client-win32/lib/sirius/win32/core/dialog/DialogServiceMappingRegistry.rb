...
module DialogServiceMappingRegistry  EncodedRegistry = ::SOAP::Mapping::EncodedRegistry.new
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::SetDlgItemText,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::SetDlgItemTextResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDlgItem,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDlgItemResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDlgCtrlID,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDlgCtrlIDResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::SetDlgItemInt,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::SetDlgItemIntResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDlgItemInt,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDlgItemIntResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDialogBaseUnits,
    :schema_type => XSD::QName.new(NsClassesWin32ServerSiriusOrg, "getDialogBaseUnits"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDialogBaseUnitsResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDlgItemTextA,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::GetDlgItemTextAResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::IsDlgButtonChecked,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Dialog::IsDlgButtonCheckedResponse,
