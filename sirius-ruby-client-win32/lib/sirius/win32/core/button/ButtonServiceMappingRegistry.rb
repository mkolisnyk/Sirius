...
module ButtonServiceMappingRegistry  EncodedRegistry = ::SOAP::Mapping::EncodedRegistry.new
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Button::GetState,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Button::GetStateResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Button::SetCheck,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Button::SetCheckResponse,
    :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "SetCheckResponse"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Button::SetState,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Button::SetStateResponse,
    :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "SetStateResponse"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Button::GetCheck,
  ...
  EncodedRegistry.register(
    :class => Sirius::Win32::Core::Button::GetCheckResponse,
