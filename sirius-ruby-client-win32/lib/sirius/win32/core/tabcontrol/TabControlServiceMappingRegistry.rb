...
module Sirius  module Win32    module Core      module Tabcontrol
        module TabControlServiceMappingRegistry  EncodedRegistry = ::SOAP::Mapping::EncodedRegistry.new
          ...
          :class => Sirius::Win32::Core::Tabcontrol::GetCurFocus,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetCurFocusResponse,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::HitTest,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::HitTestResponse,
          :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "HitTestResponse"),
          :schema_element => [
            ["v_return", ["Sirius::Win32::Core::Tabcontrol::TcHITTESTINFO", XSD::QName.new(nil, "return")], [0, 1]]
          ]
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::TcHITTESTINFO,
          ...
          :schema_element => [
            ...
            ["pt", ["Sirius::Win32::Core::Tabcontrol::Point", XSD::QName.new(nil, "pt")], [0, 1]],
            ["flags", ["SOAP::SOAPInt", XSD::QName.new(nil, "flags")]]
          ]
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::Point,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetRowCount,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetRowCountResponse,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetItemCount,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetItemCountResponse,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetItemRect,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetItemRectResponse,
          :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "GetItemRectResponse"),
          :schema_element => [
            ["v_return", ["Sirius::Win32::Core::Tabcontrol::Rect", XSD::QName.new(nil, "return")], [0, 1]]
          ]
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::Rect,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetCurSel,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetCurSelResponse,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::SetCurFocus,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::SetCurFocusResponse,
          :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "SetCurFocusResponse"),
          :schema_element => []
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::SetCurSel,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::SetCurSelResponse,
          :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "SetCurSelResponse"),
          :schema_element => []
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetItem,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::GetItemResponse,
          :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "GetItemResponse"),
          :schema_element => [
            ["v_return", ["Sirius::Win32::Core::Tabcontrol::TcITEM", XSD::QName.new(nil, "return")], [0, 1]]
          ]
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::TcITEM,
          ...
          :schema_element => [
            ...
            ["lParam", ["Sirius::Win32::Core::Tabcontrol::Lparam", XSD::QName.new(nil, "lParam")], [0, 1]]
          ]
          )

          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::Lparam,
          ...
          EncodedRegistry.register(
          :class => Sirius::Win32::Core::Tabcontrol::LongPTR,
