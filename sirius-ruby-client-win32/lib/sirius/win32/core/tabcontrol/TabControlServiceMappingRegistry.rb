...
module TabControlServiceMappingRegistry  EncodedRegistry = ::SOAP::Mapping::EncodedRegistry.new
  ...
  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::GetSelectedItem,
  ...
  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::GetSelectedItemResponse,
  ...
  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::SelectByIndex,
  ...
  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::SelectByIndexResponse,
    :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "SelectByIndexResponse"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::Select,
    :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "Select"),
    :schema_element => [
      ["arg0", ["SOAP::SOAPLong", XSD::QName.new(nil, "arg0")]],
  ...
  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::SelectResponse,
    :schema_type => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "SelectResponse"),
    :schema_element => []
  )

  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::GetItemNames,
  ...
  EncodedRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::GetItemNamesResponse,
  ...
  LiteralRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::Select,
    :schema_name => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "Select"),
    :schema_element => [
      ["arg0", ["SOAP::SOAPLong", XSD::QName.new(nil, "arg0")]],
      ["arg1", ["SOAP::SOAPString", XSD::QName.new(nil, "arg1")], [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => Sirius::Client::Win32::Core::Tabcontrol::SelectResponse,
    :schema_name => XSD::QName.new(NsControlsClassesWin32ServerSiriusOrg, "SelectResponse"),
    :schema_element => []
  )
