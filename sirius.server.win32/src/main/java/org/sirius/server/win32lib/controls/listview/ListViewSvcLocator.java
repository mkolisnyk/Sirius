...
public class ListViewSvcLocator extends org.apache.axis.client.Service
        implements org.sirius.server.win32lib.controls.listview.ListViewSvc {
    ...
    public ListViewSvcLocator(final java.lang.String wsdlLoc,
            final javax.xml.namespace.QName sName)
            throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    public ListViewSvcLocator(final org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    @Override
    public org.sirius.server.win32lib.controls.listview.IListViewContract getListViewSvcPort()
            throws javax.xml.rpc.ServiceException {
    ...
    public org.sirius.server.win32lib.controls.listview.IListViewContract getListViewSvcPort(
            ...
            throws javax.xml.rpc.ServiceException {
        try {
            org.sirius.server.win32lib.controls.listview.ListViewSvcPortStub _stub = new org.sirius.server.win32lib.controls.listview.ListViewSvcPortStub(
                    portAddress, this);
    ...
    public java.rmi.Remote getPort(final Class serviceEndpointInterface)
            throws javax.xml.rpc.ServiceException {
        try {
            if (org.sirius.server.win32lib.controls.listview.IListViewContract.class
                    .isAssignableFrom(serviceEndpointInterface)) {
                org.sirius.server.win32lib.controls.listview.ListViewSvcPortStub _stub = new org.sirius.server.win32lib.controls.listview.ListViewSvcPortStub(
                        new java.net.URL(ListViewSvcPort_address), this);
                _stub.setPortName(getListViewSvcPortWSDDServiceName());
                return _stub;
            }
    ...
    public void setListViewSvcPortEndpointAddress(final java.lang.String address) {
        ListViewSvcPort_address = address;
    }

    public void setListViewSvcPortWSDDServiceName(final java.lang.String name) {
