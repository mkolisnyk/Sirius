...
public class DialogProxy implements
        org.sirius.client.win32.core.classes.dialog.Dialog {
    ...
    private void _initDialogProxy() {
        try {
            dialog = (new org.sirius.client.win32.core.classes.dialog.DialogServiceLocator())
                    .getDialogPort();
            if (dialog != null) {
                if (_endpoint != null)
                    ((javax.xml.rpc.Stub) dialog)
                            ._setProperty(
                                    "javax.xml.rpc.service.endpoint.address",
                                    _endpoint);
                else
                    _endpoint = (String) ((javax.xml.rpc.Stub) dialog)
    ...
    public void setEndpoint(String endpoint) {
        _endpoint = endpoint;
        if (dialog != null)
            ((javax.xml.rpc.Stub) dialog)._setProperty(
