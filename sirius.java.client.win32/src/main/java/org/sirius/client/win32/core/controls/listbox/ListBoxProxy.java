...
public class ListBoxProxy implements
        org.sirius.client.win32.core.controls.listbox.ListBox {
    ...
    private void _initListBoxProxy() {
        try {
            listBox = (new org.sirius.client.win32.core.controls.listbox.ListBoxServiceLocator())
                    .getListBoxPort();
            if (listBox != null) {
                if (_endpoint != null)
                    ((javax.xml.rpc.Stub) listBox)
                            ._setProperty(
                                    "javax.xml.rpc.service.endpoint.address",
                                    _endpoint);
                else
                    _endpoint = (String) ((javax.xml.rpc.Stub) listBox)
    ...
    public void setEndpoint(String endpoint) {
        _endpoint = endpoint;
        if (listBox != null)
            ((javax.xml.rpc.Stub) listBox)._setProperty(
    ...
    public java.lang.String getText(long arg0, int arg1)
            throws java.rmi.RemoteException {
        if (listBox == null)
            _initListBoxProxy();
    ...
    public int setSel(long arg0, boolean arg1, int arg2)
            throws java.rmi.RemoteException {
        if (listBox == null)
            _initListBoxProxy();
    ...
    public int selItemRange(long arg0, boolean arg1, int arg2, int arg3)
            throws java.rmi.RemoteException {
        if (listBox == null)
            _initListBoxProxy();
