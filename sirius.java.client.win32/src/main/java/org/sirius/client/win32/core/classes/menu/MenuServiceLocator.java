...
public class MenuServiceLocator extends org.apache.axis.client.Service
        implements org.sirius.client.win32.core.classes.menu.MenuService {
    ...
    public MenuServiceLocator(java.lang.String wsdlLoc,
    ...
    public org.sirius.client.win32.core.classes.menu.Menu getMenuPort(
        ...
        try {
            org.sirius.client.win32.core.classes.menu.MenuPortBindingStub _stub = new org.sirius.client.win32.core.classes.menu.MenuPortBindingStub(
                    portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface)
            throws javax.xml.rpc.ServiceException {
        try {
            if (org.sirius.client.win32.core.classes.menu.Menu.class
                    .isAssignableFrom(serviceEndpointInterface)) {
                org.sirius.client.win32.core.classes.menu.MenuPortBindingStub _stub = new org.sirius.client.win32.core.classes.menu.MenuPortBindingStub(
                        new java.net.URL(MenuPort_address), this);
                _stub.setPortName(getMenuPortWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName(
                "http://classes.win32.server.sirius.org/", "MenuService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName(
                    "http://classes.win32.server.sirius.org/", "MenuPort"));
        }
