...
public class SystemOperationsServiceLocator extends org.apache.axis.client.Service implements org.sirius.client.core.system.sys.SystemOperationsService {

    public SystemOperationsServiceLocator() {
    }


    public SystemOperationsServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public SystemOperationsServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public org.sirius.client.core.system.sys.SystemOperations getSystemOperationsPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.sirius.client.core.system.sys.SystemOperationsPortBindingStub _stub = new org.sirius.client.core.system.sys.SystemOperationsPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.sirius.client.core.system.sys.SystemOperations.class.isAssignableFrom(serviceEndpointInterface)) {
                org.sirius.client.core.system.sys.SystemOperationsPortBindingStub _stub = new org.sirius.client.core.system.sys.SystemOperationsPortBindingStub(new java.net.URL(SystemOperationsPort_address), this);
                _stub.setPortName(getSystemOperationsPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://system.server.sirius.org/", "SystemOperationsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://system.server.sirius.org/", "SystemOperationsPort"));
        }
