...
public class SystemOperationsProxy implements org.sirius.client.core.system.sys.SystemOperations {
  ...
  private void _initSystemOperationsProxy() {
    try {
      systemOperations = (new org.sirius.client.core.system.sys.SystemOperationsServiceLocator()).getSystemOperationsPort();
      if (systemOperations != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)systemOperations)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)systemOperations)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
