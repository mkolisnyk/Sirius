...
public class FileOperationsProxy implements org.sirius.client.core.system.file.FileOperations {
  ...
  private void _initFileOperationsProxy() {
    try {
      fileOperations = (new org.sirius.client.core.system.file.FileOperationsServiceLocator()).getFileOperationsPort();
      if (fileOperations != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)fileOperations)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)fileOperations)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
