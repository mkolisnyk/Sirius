...
public class ProcessInfo  implements java.io.Serializable {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProcessInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://system.server.sirius.org/", "processInfo"));
