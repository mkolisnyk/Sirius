...
public class ProcessOperationsProxy implements org.sirius.client.core.system.process.ProcessOperations {
  ...
  private void _initProcessOperationsProxy() {
    try {
      processOperations = (new org.sirius.client.core.system.process.ProcessOperationsServiceLocator()).getProcessOperationsPort();
      if (processOperations != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)processOperations)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)processOperations)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
