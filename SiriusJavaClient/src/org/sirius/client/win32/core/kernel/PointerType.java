...
public abstract class PointerType implements java.io.Serializable {
	private org.sirius.client.win32.core.kernel.Pointer pointer;

	public PointerType() {
	}

	public PointerType(org.sirius.client.win32.core.kernel.Pointer pointer) {
	 ...
	 * @return pointer
	 */
	public org.sirius.client.win32.core.kernel.Pointer getPointer() {
		return pointer;
	}
	 ...
	 * @param pointer
	 */
	public void setPointer(org.sirius.client.win32.core.kernel.Pointer pointer) {
		this.pointer = pointer;
	}
