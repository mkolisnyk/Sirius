...
public class Windowinfo extends org.sirius.client.win32.core.user32.Structure
		implements java.io.Serializable {
	private int cbSize;

	private org.sirius.client.win32.core.user32.Rect rcWindow;

	private org.sirius.client.win32.core.user32.Rect rcClient;
	...
	public Windowinfo(boolean autoRead, boolean autoWrite, int cbSize,
			org.sirius.client.win32.core.user32.Rect rcWindow,
			org.sirius.client.win32.core.user32.Rect rcClient, int dwStyle,
			int dwExStyle, int dwWindowStatus, int cxWindowBorders,
			int cyWindowBorders, short atomWindowType, short wCreatorVersion) {
	 ...
	 * @return rcWindow
	 */
	public org.sirius.client.win32.core.user32.Rect getRcWindow() {
		return rcWindow;
	}
	 ...
	 * @param rcWindow
	 */
	public void setRcWindow(org.sirius.client.win32.core.user32.Rect rcWindow) {
		this.rcWindow = rcWindow;
	}
	 ...
	 * @return rcClient
	 */
	public org.sirius.client.win32.core.user32.Rect getRcClient() {
		return rcClient;
	}
	 ...
	 * @param rcClient
	 */
	public void setRcClient(org.sirius.client.win32.core.user32.Rect rcClient) {
		this.rcClient = rcClient;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.rcWindow == null && other.getRcWindow() == null) || (this.rcWindow != null && this.rcWindow
						.equals(other.getRcWindow())))
				&& ((this.rcClient == null && other.getRcClient() == null) || (this.rcClient != null && this.rcClient
						.equals(other.getRcClient())))
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("", "dwWindowStatus"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "int"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("", "atomWindowType"));
		elemField.setXmlType(new javax.xml.namespace.QName(
