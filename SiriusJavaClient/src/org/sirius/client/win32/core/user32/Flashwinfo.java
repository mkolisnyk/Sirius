...
public class Flashwinfo extends org.sirius.client.win32.core.user32.Structure
		implements java.io.Serializable {
	private int cbSize;

	private org.sirius.client.win32.core.user32.Handle hWnd;
	...
	public Flashwinfo(boolean autoRead, boolean autoWrite, int cbSize,
			org.sirius.client.win32.core.user32.Handle hWnd, int dwFlags,
			int uCount, int dwTimeout) {
	 ...
	 * @return hWnd
	 */
	public org.sirius.client.win32.core.user32.Handle getHWnd() {
		return hWnd;
	}
	 ...
	 * @param hWnd
	 */
	public void setHWnd(org.sirius.client.win32.core.user32.Handle hWnd) {
		this.hWnd = hWnd;
	}
