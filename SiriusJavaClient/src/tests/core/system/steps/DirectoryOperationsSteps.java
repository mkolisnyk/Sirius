...
public class DirectoryOperationsSteps extends DirectoryOperationsProxy {
	...
	public boolean copy(String origin, String destination)
			throws org.sirius.client.core.system.dir.IOException,
			RemoteException {
	...
	public boolean copyEx(String origin, String destination, String with)
			throws org.sirius.client.core.system.dir.IOException,
			RemoteException {
	...
	public boolean moveDirectoryEx(@WebParam(name = "origin") String arg0,
			...
			@WebParam(name = "overwrite") boolean arg2)
			throws org.sirius.client.core.system.dir.IOException,
			RemoteException {
