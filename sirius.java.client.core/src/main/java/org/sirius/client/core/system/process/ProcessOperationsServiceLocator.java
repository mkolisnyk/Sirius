...
public class ProcessOperationsServiceLocator extends
        org.apache.axis.client.Service implements
        org.sirius.client.core.system.process.ProcessOperationsService {
    ...
    public ProcessOperationsServiceLocator(java.lang.String wsdlLoc,
    ...
    public org.sirius.client.core.system.process.ProcessOperations getProcessOperationsPort(
        ...
        try {
            org.sirius.client.core.system.process.ProcessOperationsPortBindingStub _stub = new org.sirius.client.core.system.process.ProcessOperationsPortBindingStub(
                    portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface)
            throws javax.xml.rpc.ServiceException {
        try {
            if (org.sirius.client.core.system.process.ProcessOperations.class
                    .isAssignableFrom(serviceEndpointInterface)) {
                org.sirius.client.core.system.process.ProcessOperationsPortBindingStub _stub = new org.sirius.client.core.system.process.ProcessOperationsPortBindingStub(
                        new java.net.URL(ProcessOperationsPort_address), this);
                _stub.setPortName(getProcessOperationsPortWSDDServiceName());
                return _stub;
            }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName(
                "http://system.server.sirius.org/", "ProcessOperationsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName(
                    "http://system.server.sirius.org/", "ProcessOperationsPort"));
        }
