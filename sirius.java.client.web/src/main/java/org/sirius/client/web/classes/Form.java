...
public class Form extends Frame {
	 ...
	 * 
	 * @param client
	 *            the reference to org.sirius.client.web.WebClient object.
	 * @param locator
	 *            the string representing the search criteria for the current
	 *            object.
	 */
	...
	public final String name() throws RemoteException {
		return this.getClient().core().getAttribute(null, getLocator(), "name");
	}

	/**
	 * Submits current form by clicking the button which is defined as the type
	 * <b>submit</b> and belongs to current form.
	 * 
	 * @throws RemoteException
	 *             thrown when there's no connection with the server or some
	 *             other connectivity problems.
