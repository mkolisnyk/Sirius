...
/**
 * Contains core API for interaction with the Web applications. It's purely core
 * and plain API which is the basis for high-level window classes library in the
 * <b>org.sirius.client.web.classes</b> package.
 * 
 * @author Myk Kolisnyk
 */
public class WebClientCoreProxy extends WebCoreProxy {
	...
	/**
	 * Contains the value of currently open browser session. All other methods
	 * implicitly reference this token while making the calls.
	 */
	private String token = "";

	/**
	 * Additional reference to the proxy class responsible for interacting with
	 * the Web lists.
	 */
	private WebSelectProxy select;

	/**
	 * Initializes Core Web proxy instance using default host:
	 * <b>http://localhost:21212</b>.
	 */
	 ...
	 * 
	 * @param endpoint
	 *            the host where remote Server module listens to
	 */
	 ...
	 * @throws RemoteException .
	 */
	public final void selectFrameByIndex(final int arg1) throws RemoteException {
