...
public class WebCoreServiceLocator extends org.apache.axis.client.Service implements org.sirius.client.web.core.WebCoreService {
    ...
    public WebCoreServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public org.sirius.client.web.core.WebCore getWebCorePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.sirius.client.web.core.WebCorePortBindingStub _stub = new org.sirius.client.web.core.WebCorePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.sirius.client.web.core.WebCore.class.isAssignableFrom(serviceEndpointInterface)) {
                org.sirius.client.web.core.WebCorePortBindingStub _stub = new org.sirius.client.web.core.WebCorePortBindingStub(new java.net.URL(WebCorePort_address), this);
                _stub.setPortName(getWebCorePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://web.server.sirius.org/", "WebCoreService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://web.server.sirius.org/", "WebCorePort"));
        }
