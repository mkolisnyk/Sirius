...
public class WebSelectProxy implements org.sirius.client.web.select.WebSelect {
  ...
  private void _initWebSelectProxy() {
    try {
      webSelect = (new org.sirius.client.web.select.WebSelectServiceLocator()).getWebSelectPort();
      if (webSelect != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)webSelect)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)webSelect)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
