...
svcutil /t:code http://localhost:21212/web/core?wsdl /d:.\Sirius.Client\Web.Core /n:*,Sirius.Client.Web.Core  /svcutilConfig:App.config

svcutil /t:code http://localhost:21212/web/select?wsdl /d:.\Sirius.Client\Web.Select /n:*,Sirius.Client.Web.Select  /svcutilConfig:App.config
